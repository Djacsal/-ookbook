...
<head>
    ...
    <meta name="description" content="Друзья мои хочу поделиться с Вами приготовлением очень вкусного блюда, речь пойдет о шампиньонах с 
    беконом в сливочном соусе. Блюдо готовиться или как гарнир, или как самостоятельное грибное блюдо. 
    Получается очень вкусно, рекомендую попробовать всем, кто любит грибы, или просто хорошую кухню!">
    <link rel="stylesheet" href="/css/Dish.css?<?echo time();?>">
    <link rel="stylesheet" href="/css/Normalize.css">
    <title>Шампиньоны с беконом в соусе</title>
</head>
<body>
    <header>
        <div class="head">
            ...
            <div class="dish">
                <div class="dish_head dish_container">
                    <div class="dish_title">
                        <p class="dish_title">Шампиньоны с беконом в соусе</p>
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4.png" alt="Шампиньоны с беконом в соусе" width="750px">
                    </div>
                    <div class="dish_info">
                        Друзья мои хочу поделиться с Вами приготовлением очень вкусного блюда, речь пойдет о шампиньонах с 
                        беконом в сливочном соусе. Блюдо готовиться или как гарнир, или как самостоятельное грибное блюдо. 
                        Получается очень вкусно, рекомендую попробовать всем, кто любит грибы, или просто хорошую кухню!
                    </div>
                </div>
                <div class="dish_ingredients dish_container">
                    ...
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/1.jpg" alt="Ингридиенты" width="650px">
                    </div>
                    <div class="dish_info">
                        Пятьсот грамм шампиньонов;<br>
                        Сто грамм бекона;<br>
                        Сливок двести пятьдесят миллилитров;<br>
                        Масла растительного две столовые ложки;<br>
                        Луковицу одну штуку;<br>
                        Одну чайную ложку соли;<br>
                        Молотого черного перца десять грамм;<br>
                ...
                <div class="dish_recipe dish_container">
                    ...
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/2.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Возьмите посуду для жарки. Отправьте туда наш бекон, мелко порезанный. 
                        Добавляем к бекону пару листиков тимьяна. Жарьте бекон около десяти минут.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/3.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Снимите с грибных шляпок пленку. Нарежьте грибочки в виде пластинок. Возьмите луковицу, почистите ее и нарежьте.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/4.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Добавьте к бекону грибочки.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/5.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Далее пожарьте грибы около десяти минут.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/6.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Добавляем далее наш лук.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/7.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        После этого положите в блюдо чеснок пару зубчиков.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/8.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        После чего посолите и поперчите шампиньоны.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/9.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Протушите все еще минут десять.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/10.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Теперь пришла очередь добавлять сливки. Перемешайте грибную смесь со сливками.
                    </div>
                    <div class="dish_img">
                        <img class="img_width" src="/img/Mushrooms_vegetables_img/4/11.jpg" width="650px">
                    </div>
                    <div class="dish_info">
                        Протушите все еще минут двенадцать. Подавать блюдо можно как холодным, так и горячим. 
                        Желаю Вам приятного вкушения этого замечательного блюда!
                    </div>
                </div>
            </div>
        </div>
